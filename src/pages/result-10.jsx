      ...
      render={({ state, fullpageApi }) => {
        return (
          <div className="h-full">
            <FullScreenSection>
              <div className="bg-ft-dark-green h-full w-screen flex items-center justify-center flex-col">
                <svg
            ...
            <FullScreenSection>
              <div className="bg-ft-blue h-screen w-screen flex items-center justify-center flex-col">
                ...
                <h1 className="font-alegreya 2xl:text-6xl sm:text-5xl text-4xl mx-4 sm:mx-0 text-white max-w-2xl md:max-w-5xl text-center mt-6 ">
                  All your tea choices are Fairtrade-certified. That makes you a
                  hero in our eyes.
                </h1>
              </div>
            </FullScreenSection>
                        ...
                        <div className=" flex flex-col justify-center items-center sm:mx-4 lg:mx-0">
                          ...
                          <div className="lg:col-span-1 relative grid grid-cols-3 max-w-lg">
                            ...
                            <div
                              ...
                              className="col-span-1 tea cursor-pointer flex items-end mt-6"
                            >
                              <Image
                                src="/img/ft-tea.png"
                                width={400}
