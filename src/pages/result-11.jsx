            ...
            <FullScreenSection>
              <div className="bg-ft-blue h-screen w-screen flex items-center justify-center flex-col">
                ...
                <h1 className="font-alegreya 2xl:text-6xl sm:text-5xl text-4xl mx-4 sm:mx-0 text-white max-w-2xl md:max-w-5xl text-center mt-6">
                  All your coffee choices are Fairtrade-certified. That makes
                  you a hero in our eyes.
                </h1>
              </div>
            </FullScreenSection>
            <FullScreenSection>
              <div className=" z-50  w-screen h-full">
                <div
                  className={
                    disclamerToggled
                      ...
                      <div className="flex justify-center items-center h-full">
                        <div className=" flex flex-col justify-center items-center sm:mx-4 lg:mx-0">
                          <div className="mx-4 sm:mx-0">
                            <h1 className="font-alegreya 2xl:!text-7xl sm:!text-5xl text-base xs:text-3xl lg:max-w-2xl text-center xs:mb-6 pt-2 xs:t-6 sm:pt-0">
