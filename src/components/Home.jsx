    ...
    <div className="relative min-h-screen">
      ...
      <div className={`${styles.boxWidth} mx-auto`}>
        <div className="grid lg:grid-cols-2">
          <div className="flex flex-col justify-center space-y-4 sm:space-y-6 lg:space-y-8 2xl:space-y-8 mx-auto z-50 py-4 lg:py-20">
            ...
            <div className="border-l-2 lg:py-14 border-ft-blue">
              <div className="space-y-2 sm:space-y-4 lg:space-y-6 2xl:space-y-8 mx-4 sm:mx-6 lg:mx-10">
